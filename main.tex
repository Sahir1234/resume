...
\header{Education}
    \vspace{4pt}
    \school{University of Maryland}{College Park, MD}{August 2018 -- May 2022}
    {\textit{Bachelor of Science in Computer Science with Business Analytics Minor} \labelitemi  GPA: 3.98/4.0}
...
\header{Technical Skills}
    ...
    \item \textbf{Programming Languages}: \cvtag{Java}\cvtag{Python}\cvtag{C}\cvtag{HTML}\cvtag{CSS}\cvtag{JavaScript}\cvtag{OCaml}\cvtag{Ruby}
    \vspace{4pt}
    \item \textbf{Libraries/Frameworks}:  \cvtag{Flask}\cvtag{Keras}\cvtag{Scikit-Learn}\cvtag{Pandas}\cvtag{jQuery}\cvtag{Express}\cvtag{C3.js}\cvtag{Chart.js}\cvtag{Angular}
    \vspace{4pt}
    \item \textbf{Technologies/Softwares}: \cvtag{Node.js}\cvtag{GitHub}\cvtag{LaTeX}\cvtag{Heroku}\cvtag{Amazon Web Services}\cvtag{Google Suite}\cvtag{Microsoft Office}
    \vspace{4pt}
    \item \textbf{Relevant Coursework}: \cvtag{Object-Oriented Programming}\cvtag{Discrete Math}\cvtag{Computer Systems}\cvtag{Algorithms and Analysis} \\ \smallskip
