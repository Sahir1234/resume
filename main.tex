...
\header{Technical Skills}
    ...
    \vspace{4pt}
    \textbf{Technologies}: \hspace{3pt}\cvtag{Amazon Web Services}\hspace{3pt}\cvtag{Git}\hspace{3pt}\cvtag{Flask}\hspace{3pt}\cvtag{Keras}\cvtag{Node.js}\hspace{3pt}\hspace{3pt}\cvtag{Express}\hspace{3pt}\cvtag{jQuery}\cvtag{Mockito}\hspace{3pt}
\smallskip
\medskip
