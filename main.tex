...
\header{Experience}
	...
	\begin{bullet-list-minor}
        ...
        \item Tracked root causes of automated test suite failures blocking deployments across multiple teams, and collaborated with product managers to outline and prioritize projects to reduce test failure rates by over 50\% and increase developer agility
