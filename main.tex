...
\header{Education}
    \vspace{4pt}
    \school{University of Maryland}{\textit{College Park, MD}}{August 2018 -- May 2022}{\vspace{2pt}  Bachelor of Science in Computer Science with Business Analytics Minor \labelitemi Cumulative GPA: 3.96/4.0}
...
\header{Technical Skills}
    \vspace{4pt}
    \textbf{Programming Languages}: \cvtag{Java}\cvtag{Python}\cvtag{C}\cvtag{HTML}\cvtag{CSS}\cvtag{JavaScript}\cvtag{OCaml}\cvtag{Ruby}\cvtag{SQL}\cvtag{R}\\
    \vspace{4pt}
