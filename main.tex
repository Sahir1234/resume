...
\header{Technical Skills}
    ...
    \vspace{4pt}
    \textbf{Technologies}: \hspace{3pt} \cvtag{Git}\hspace{3pt}\cvtag{Flask}\hspace{3pt}\cvtag{Keras}\hspace{3pt}\cvtag{Pandas}\hspace{3pt}\cvtag{Mockito}\hspace{3pt}\cvtag{Node.js}\hspace{3pt}\cvtag{jQuery}\hspace{3pt}\cvtag{Amazon Web Services}
...
\header{Experience}
	...
	\begin{bullet-list-minor}
	    \item Building a Java REST API to extend Amazon's Catalog Relationships logic to support more use cases for Sellers/Vendors
	    \item Integrated Smithy and Coral to define service interface and Guice and Mockito for dependency injection and mocking
	    \item Implementing access clients to read Catalog data from external services and health tests for clients in each deployment stage
	    \item Acting as Kanban Master and re-organizing the team's Kanban process to facilitate knowledge sharing among team members
